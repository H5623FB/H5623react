...
class Spirits extends Component {
  ...
  componentWillMount() {
    ...
    let openRef = fire.database().ref("ILEC/Pub/ClosingForm/Spirits/Open");
    ...
    let saleRef = fire.database().ref("ILEC/Pub/ClosingForm/Spirits/Sold");
    saleRef.on("value", snapshot => {
      let sale = { id: snapshot.key, text: snapshot.val() };
      let saleqty = sale.text;
      this.setState({ sale: saleqty });
    });
    let closingRef = fire.database().ref("ILEC/Pub/ClosingForm/Spirits/Close");
    ...
    let deliveredRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Spirits/Delivered");
    ...
    let transfersRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Spirits/Transfers");
    ...
    let wastageRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Spirits/Wastage");
