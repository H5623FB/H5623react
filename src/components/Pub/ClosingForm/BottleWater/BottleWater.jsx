...
class BottleWater extends Component {
  ...
  componentWillMount() {
    ...
    let openRef = fire.database().ref("ILEC/Pub/ClosingForm/BottleWater/Open");
    ...
    let saleRef = fire.database().ref("ILEC/Pub/ClosingForm/BottleWater/Sold");
    ...
    let transfersRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/BottleWater/Transfers");
    ...
    let wastageRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/BottleWater/Wastage");
