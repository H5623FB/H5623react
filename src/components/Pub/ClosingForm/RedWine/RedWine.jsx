...
class RedWine extends Component {
  ...
  componentWillMount() {
    ...
    let openRef = fire.database().ref("ILEC/Pub/ClosingForm/Red Wine/Open");
    ...
    let saleRef = fire.database().ref("ILEC/Pub/ClosingForm/Red Wine/Sold");
    saleRef.on("value", snapshot => {
      let sale = { id: snapshot.key, text: snapshot.val() };
      let saleqty = sale.text;
      this.setState({ sale: saleqty });
    });
    let closingRef = fire.database().ref("ILEC/Pub/ClosingForm/Red Wine/Close");
    ...
    let transfersRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Red Wine/Transfers");
    ...
    let wastageRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Red Wine/Wastage");
  ...
  submitChange = e => {
    ...
    fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Red Wine/Close")
