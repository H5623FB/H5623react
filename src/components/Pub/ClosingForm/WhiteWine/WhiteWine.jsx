...
class WhiteWine extends Component {
  ...
  componentWillMount() {
    ...
    let openRef = fire.database().ref("ILEC/Pub/ClosingForm/White Wine/Open");
    ...
    let saleRef = fire.database().ref("ILEC/Pub/ClosingForm/White Wine/Sold");
    ...
    let closingRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/White Wine/Close");
    ...
    let transfersRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/White Wine/Transfers");
    ...
    let wastageRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/White Wine/Wastage");
